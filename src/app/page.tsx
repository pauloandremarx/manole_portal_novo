      ...
      <section className="uk-margin-large-top">
                <div className="container_padrao ">
                    <div className={`${styles.sobre_nos} uk-child-width-1-2@m  uk-grid`} data-uk-grid>
                        ...
                        <div>
                            ...
                            com todos os envolvidos – colaboradores, parceiros e clientes –, trabalhamos para a realização
                            do nosso objetivo: promover um ecossistema acessível e altamente qualificado de produtos e
                            serviços que unem conhecimento e tecnologia para transformar a carreira do profissional nas
            ...
            <section>
                <div className={`${styles.container_icons} uk-margin-large-bottom`}>
                    ...
                    <div className={`${styles.icons_home} uk-child-width-1-4@m uk-child-width-1-2  uk-grid`}  data-uk-grid>
                        <div>
                            <div>
                                <div className="uk-flex uk-flex-center">
                ...
                <div    className={`${styles.bg_cinza} `}>
                    <div className="container_padrao" >
                        ...
                        <div   className={`${styles.itens_bg_cinza} ${styles.i_verde}  uk-grid`}   data-uk-grid >
                            <div  className={`   uk-width-2-5@m uk-width-1-1 uk-flex uk-flex-middle ${styles.border_right}`}>
                                <div className="">
                                    <h2>HealthTech+</h2>
                                    <h3>soluções</h3>
                                </div>
                            ...
                            <div className="uk-width-3-5@m uk-width-1-1">
                                <p>
                                    ...
                                    serviço do conhecimento, a Manole oferece soluções personalizadas e altamente eficientes
                                    ...
                                    treinamentos, elaboração de plataforma educacional (LMS) e e-congress, com a cobertura
                        ...
                        <div className={`${styles.itens_bg_cinza}  ${styles.i_laranja} uk-grid`}   data-uk-grid >
                            ...
                            <div className="uk-width-3-5@m uk-width-1-1 ">
                                <p  className={`${styles.max_width_p} `}>
                                    Há 10 anos no mercado, a Manole Educação vem cumprindo o objetivo de organizar conteúdos
                                    de alta complexidade e torná-los acessíveis a profissionais e acadêmicos em todo o
                                    Brasil e no mundo por meio de recursos tecnológicos de aprendizagem ágeis e funcionais.
                                    Contamos com centenas de cursos realizados em diferentes especialidades médicas e de
                                    saúde e celebramos até o momento mais de 120 mil alunos, criando pontes entre pessoas e os
                                    conhecimentos reunidos por renomadas instituições e professores que são referências em
                                    seus campos de atuação.
                                </p>
                            </div>

                            <div  className={`uk-width-2-5@m uk-width-1-1 uk-flex uk-flex-middle ${styles.border_left} `} >
                                <div className="">
                                    <h2>Saúde+</h2>
                                    <h3>educação</h3>
                                </div>
                    ...
                    <div className="container_padrao uk-margin-xlarge-top" >
                        ...
                        <div className={`${styles.i_azul} ${styles.itens_bg_cinza}   uk-grid`}  data-uk-grid >
                            ...
                            <div className={`${styles.border_right} uk-width-2-5@m uk-width-1-1 uk-flex uk-flex-middle `}>
                                <div className="">
                                    <h2>EdTech+</h2>
                                    <h3>editora</h3>
                                </div>
                            ...
                            <div className="uk-width-3-5@m uk-width-1-1">
                                <p>
                                Há mais de 50 anos, a Manole produz e lança no mercado títulos selecionados que contribuem para a expansão do conhecimento nas áreas da Saúde e no segmento técnico-científico. Em seu percurso editorial, cada obra recebe um cuidado diferenciado e altamente especializado que, somado às parcerias com autores e instituições de grande renome, garante a indiscutível qualidade que é marca registrada das publicações sob a marca Manole. São mais de 4 mil títulos publicados até o momento, diversos best sellers e projetos premiados.
                                </p>
                            </div>
