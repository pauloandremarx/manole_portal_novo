          ...
          header={
            <>
              ...
              <Image
                  width={15}
                  height={15}
                  className={`${styles.chevron} next_img`}
                  src="/manole/perfil/arrow-down.svg"
                  alt="Chevron Down"
              />
            </>
          }
            ...
            <div className={`   `}>
              <section className={`  ${styles.container_painel} `}>
                ...
                <div className="uk-grid uk-grid-large uk-child-width-1-2@m">
                  <div>
                    <h1
                        className={`${styles.informacoes_perfil} uk-margin-large-top`}
                    >
                      Minhas notas
                    </h1>
                    ...
                    <div className={`${styles.container_form} `}>
                      <div className={`uk-margin`}>
                        <Accordion>
                          ...
                          <AccordionItem header="Notas de cursos concluidos"></AccordionItem>
                        </Accordion>
                      </div>
                    </div>
                  </div>
