...
const Header = () => { 
  ...
  return (
   ...
   <div className={`${styles.nav}`}  >
            <div id={`${styles.id_nav} id_nav`} className={'uk-sticky uk-sticky-fixed'} >
                                ...
                                {logado ?(
                                            ...
                                            <div className='uk-flex uk-flex-middle'>
                                                ...
                                                <div  className={`${styles.username_dropdown}`} data-uk-dropdown="mode: click">
                                                    <Link  href={ `/painel/${getLocalStorage('username')}/${getLocalStorage('userid')} `} legacyBehavior><a>Painel</a></Link>
                                                    <Link  href={ `/painel/${getLocalStorage('username')}/${getLocalStorage('userid')}/meu-perfil `} legacyBehavior><a>Meu perfil</a></Link>
                            ...
                            <div className="uk-navbar-nav uk-hidden@m">
                                <div   className={`${styles.padding_right_h}`}>
                                    <a className="uk-navbar-toggle" data-uk-toggle="target: #my-mobile-nav">
                                        <span  className={`${styles.hamburgue}`} data-uk-icon="icon: menu; ratio: 2"></span>
                                    </a>
                                </div>
                            </div>
            ...
            <div  className={`uk-offcanvas-bar  uk-offcanvas-bar_v1`}>
                    ...
                    <div   className={`${styles.nav_mobile_header_container}`}>
                        <div className='uk-flex uk-flex-between'>
                            ...
                            <div className='uk-flex uk-flex-top'><button className="uk-offcanvas-close uk-display-block uk-position-relative" type="button"  data-uk-close></button></div>
                        </div>
                    </div>
                    <ul className={ ` ${styles.nav_mobile_container} uk-nav uk-nav-default uk-width-1-1 uk-margin-top`}>
