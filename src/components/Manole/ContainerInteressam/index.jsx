    ...
    return status === 'loading' ? (
        ...
        <div className="uk-position-relative" tabIndex="-1" data-uk-slider>
            ...
            <div className={`uk-slider-container ${styles.padding_x}`} >
                <div className={`uk-slider-items uk-child-width-1-5@l uk-child-width-1-4@m uk-flex-center uk-margin-large-top  uk-grid`} >
            ...
            <a className="uk-position-center-left uk-position-small  " href="#"
               data-uk-slider-item="previous"><div className={styles.circleShadow}><img src="/manole/perfil/left-sm.svg" /></div></a>
            <a className="uk-position-center-right uk-position-small  " href="#"
               data-uk-slider-item="next"><img className={styles.circleShadow} src="/manole/perfil/right-md.svg" /></a>
