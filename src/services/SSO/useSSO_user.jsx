...
export async function getNotification(email) {
    const res = await fetch( `https://m4.manole.h.codely.com.br/webservice/rest/server.php?wstoken=${Config.WS_TOKEN}&moodlewsrestformat=json&wsfunction=theme_manole_get_notify&user=${email}`, {
        method: "POST",
        headers: {
            'Accept': '*/*'
        },
